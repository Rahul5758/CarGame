...
public class Main extends JFrame{
    ...
    class sprit extends JPanel
    {
        ...
        Rectangle bulletRect = new Rectangle(-10, -10, bullestSizeXY[0], bullestSizeXY[1]);
        ...
        protected void paintComponent(Graphics g) {
            ...
            for(int i=0;i<traffic.length;i++)
            {
                if(traffic[i]!=null)
                {
                    ...
                    if(bulletRect!=null && isBulletActive && bulletRect.intersects(traffic[i]))
                    {
                        bulletRect = null;
                        bulletCount--;
            ...
            if(bulletRect!=null)
            {
                bulletRect.setLocation((int)bulletRect.getX(), (int)bulletRect.getY()-4);
            }

            if(bulletRect!=null && bulletRect.getY()<0)
            {
                bulletRect = null;
                bulletCount--;
                isBulletActive = false;
         ...
         // if(debugEnabled && bulletRect!=null){g.fillRect((int)bulletRect.getX(), (int)bulletRect.getY(), (int)bulletRect.getWidth(), (int)bulletRect.getHeight());}
          if(bulletRect!=null)
          {
              g.setColor(Color.yellow.darker());
              g.fillRect((int)bulletRect.getX(), (int)bulletRect.getY(), (int)bulletRect.getWidth(), (int)bulletRect.getHeight());
              g.setColor(Color.BLACK.darker());
              g.fillOval((int)bulletRect.getX(), (int)bulletRect.getY(), (int)bulletRect.getWidth(), (int)bulletRect.getHeight());
          }
          ...
          //Responding to key events
            ...
            {
                bulletRect = new Rectangle((int)(carRect.getX()+4), carY, bullestSizeXY[0], bullestSizeXY[1]);
                isBulletActive = true;
            }
